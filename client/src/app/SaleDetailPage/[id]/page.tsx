    ...
    return (
        <div className="w-full flex justify-center flex-col items-center p-5 sm:p-15">
            ...
            <div className="w-[95%] sm:w-[80%] flex flex-col sm:gap-15 gap-5">
                <div className="w-full flex flex-col sm:flex-row justify-center gap-5 sm:gap-15">
                    {post.thumbnail ? (
                        <img
                            ...
                            className="border-1 shadow-lg rounded-xl w-full sm:w-[50%] sm:h-[500px] h-[300px]"
                            alt="썸네일"
                        />
                    ) : (
                ...
                <div className="text-xl h-[80px] sm:text-2xl w-full bg-white border-4 border-[#2E7D32] p-4 rounded-md">
                    {post.content}
                </div>
