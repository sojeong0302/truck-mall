    ...
    return (
        <div className="w-[100%] h-[100%] flex items-center w-full flex-col p-0 sm:p-20 sm: mb-0 mb-10">
            ...
            <div className="sm:w-[80%] w-[90%] h-[100%] flex flex-col justify-center items-center">
                ...
                {!posts?.length ? (
                    <div className="w-full flex justify-center items-center py-10 border-b-2 border-[#575757]">
                        <span className="text-gray-500 text-sm sm:text-xl">작성된 글이 없습니다.</span>
                    </div>
                ) : (
                    posts.map((post) => (
                        <div
                        ...
                        >
                            <div className="fade-truncate p-2 font-bold w-[35%] text-center overflow-hidden whitespace-nowrap">
                                {post.title}
                            </div>
                            <div className="fade-truncate p-2 w-[25%] text-center overflow-hidden whitespace-nowrap">
                                {post.content}
                            </div>
                            ...
                            <div className="fade-truncate p-2 w-[15%] text-center overflow-hidden whitespace-nowrap">
                                {post.view}
                            </div>
                        </div>
                    ))
