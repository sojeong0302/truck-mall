        ...
        <div className="shadow-lg bg-[rgba(46,125,50,0.75)] flex flex-col gap-5 p-6 w-auto items-start rounded-4xl">
            ...
            >
                <img
                    ...
                    alt="네이버 블로그"
                    className="transition transform duration-200 hover:scale-110 active:scale-95 shadow-lg w-auto h-20 max-w-[200px] rounded-[16px]"
                />
            </a>

            {/* 카카오 오픈채팅 아이콘 */}
            <a href="https://open.kakao.com/o/sy2XQ9Eh" target="_blank" rel="noopener noreferrer">
                <ChatBubbleLeftEllipsisIcon className="transition transform duration-200 hover:scale-110 active:scale-95 shadow-lg w-auto h-20 bg-yellow-400 p-3 rounded-[16px]" />
            </a>
