            ...
            <div className="flex flex-col gap-3 p-4">
                {options.map((option) => (
                    <label key={option} className="cursor-pointer block">
                        ...
                        />
                        <div
                            className={`w-full rounded-lg border-2 px-4 py-3 transition-all duration-200 peer-checked:bg-[#2E7D32]/10 peer-checked:border-[#2E7D32] hover:border-[#2E7D32]/70 hover:bg-[#2E7D32]/5 text-lg sm:text-2xl leading-snug transition transform duration-200 active:scale-95`}
                        >
                            {option}
                        </div>
                    </label>
